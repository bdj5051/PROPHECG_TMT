...
class CausalConvolutionBlock(torch.nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, kernel_size: int,
        ...
        chomp1 = Chomp1d(padding) if forward else torch.nn.ConstantPad1d(int(padding/2),0)
        ...
        chomp2 = Chomp1d(padding) if forward else torch.nn.ConstantPad1d(int(padding/2),0)
